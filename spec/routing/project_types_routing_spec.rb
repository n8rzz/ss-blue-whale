...
RSpec.describe ProjectTypesController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #add_task_items via POST' do
      expect(:post => '/projectTypes/1/taskItems').to route_to('project_types#add_task_items', :id => '1')
    end

    it 'routes to #clear_task_items via DELETE' do
      # expect(:delete => '/projectTypes/1/taskItems/clear').to route_to('project_types#clear_task_items', :id => '1')
    end
  end
end
